"""
index.htmlにCSS/JSを全てインラインで埋め込むビルドスクリプト
"""
import os
import re

base = r'G:\マイドライブ\共通テスト数学データベース'
...
js_files = [
    ...
    os.path.join(base, 'data', 'sundai_2025_IA', 'meta.js'),
    os.path.join(base, 'data', 'sundai_2024_IA', 'meta.js'),
    os.path.join(base, 'data', 'zkai_2025_IA', 'meta.js'),
    os.path.join(base, 'data', 'kawai_2025_IA', 'meta.js'),
    os.path.join(base, 'data', 'kawai_2024_IA', 'meta.js'),
    os.path.join(base, 'data', 'zkai_2024_IA', 'meta.js'),
    os.path.join(base, 'data', 'sundai_2023_IA', 'meta.js'),
    os.path.join(base, 'data', 'kawai_2023_IA', 'meta.js'),
    os.path.join(base, 'data', 'kakomon_IA', 'meta.js'),
    os.path.join(base, 'data', 'zkai_2023_IA', 'meta.js'),
    os.path.join(base, 'data', 'sundai_2025_IIBC', 'meta.js'),
    os.path.join(base, 'data', 'sundai_2024_IIB', 'meta.js'),
    os.path.join(base, 'data', 'kawai_2025_IIBC', 'meta.js'),
    os.path.join(base, 'data', 'zkai_2025_IIBC', 'meta.js'),
    os.path.join(base, 'data', 'kakomon_IIB', 'meta.js'),
...
<head>
  ...
  <title>共通テスト数学データベース</title>
  <meta name="description" content="共通テスト数学の問題を出版社・年度・単元で横断検索し、問題と解説をワンセットで印刷できるWebアプリ">
  <style>
{css}
  </style>
</head>
  ...
  <header class="header">
    <div class="header-inner">
      <div class="logo">
        ...
        <span class="logo-text">数学DB</span>
  ...
  <section class="search-section no-print">
    <div class="search-inner">
      ...
      <div class="search-bar">
        ...
        <input type="text" id="searchInput" placeholder="タグや単元で検索（例: 余弦定理, 条件付き確率, データの分析）">
